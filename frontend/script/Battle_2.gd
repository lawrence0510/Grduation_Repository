...
# 第一組題目
var question_content = GlobalVar.battle_question["short_question2"]
var options = [GlobalVar.battle_question["shortquestion2_option1"], GlobalVar.battle_question["shortquestion2_option2"], GlobalVar.battle_question["shortquestion2_option3"], GlobalVar.battle_question["shortquestion2_option4"]]
var correct_answer = GlobalVar.battle_question["shortquestion2_answer"]
...
func _on_button_pressed(button_path: String):
	...
	update_compete_request(2, str(selected_answer))
	# 禁用其他按鈕
